...
{
    class CompteCuisinierViewModel : ViewModelBase
    {
        private readonly User _user;
        private readonly DatabaseManager _db = Database.Instance;
        private readonly CuisinierViewModel _cuisinier;
        ...
        public CompteCuisinierViewModel(User user, CuisinierViewModel cuisinier)
        {
            _user = user;
            ...
            RetourCommand = new RelayCommand(() => { _cuisinier.AfficherVuePlats();});
        }
